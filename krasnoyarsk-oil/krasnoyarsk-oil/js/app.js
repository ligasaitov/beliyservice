...
// Isotope rows
// let grid = new Isotope('.iso__list', {
// 	itemSelector: '.iso__item',
// 	layoutMode: 'fitRows',
// 	masonry: {
// 		columnWidth: '.iso__item'
// 	}
// });

// Isotope filter
// let filterBtn = document.querySelectorAll('.filter__nav .filter__nav-item');
...
// 	};
// }
// $('.filter__nav').each(function (i, buttonGroup) {
...
function map(n) {
	...
	function init() {
		var myMap = new ymaps.Map("map", {
			center: [55.76971706895294, 37.52454299999996],
			zoom: 13
		});
		...
		var myPin = new ymaps.GeoObjectCollection({}, {
			...
			iconImageSize: [60, 64],
			iconImageOffset: [-27, -65]
		});

		var myPoint = new ymaps.Placemark([55.76971706895294, 37.52454299999996], {
			balloonContentHeader: '<h4 class="ya__header">г. Москва</h4>',
			balloonContentBody: '1- я Магистральная ул. 12',
			balloonContentFooter: 'Работаем с 9:00 до 21:00',
			hintContent: '<div class="ya__tooltip">г. Москва</div>'
		});
